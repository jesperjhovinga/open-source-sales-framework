...
1. **Value Proposition & Differentiators** — What do you sell, who is it for, what makes you different, what outcomes can you prove?
2. **Sales Motion** — How do you sell? Average deal size and sales cycle length. Key personas in the buying decision.
3. **Collateral Needs** — What specific assets do you need? What stage of the funnel? Who will use them?
4. **Current State** — What materials exist today? What's working and what's not?
...
Involve reps in creation. Use their language, not marketing's. Test drafts with your top performers first.

### Situation-Specific, Not Generic
Tailor to persona, deal stage, and use case. A deck for a CTO should look different from one for a VP of Sales.

### Scannable Over Comprehensive
Reps need information in 3 seconds. Bold headers, short bullets, visual hierarchy.
...
One page, literally. Scannable in 30 seconds.
...
**Common mistakes:** Too long (aim for 5-7 pages max), too generic (customize the exec summary at minimum), burying the price.
