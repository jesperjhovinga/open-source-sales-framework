...
| `icp.md` | `context.icp(segment?)` | Fit criteria, size bands, buyer personas, disqualifiers, geography/reachability rules, winnability |
...
| `tone-of-voice.md` | `context.tone(channel)` | Voice patterns, banned/preferred words, language/locale per channel, pre-write checklist |
